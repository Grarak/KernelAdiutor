...
public class XYGraph extends View {
    ...
    public XYGraph(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int accentColor = Utils.getThemeAccentColor(context);
        ...
        graphColor = Color.argb(255 / 2, Color.red(graphColor), Color.green(graphColor), Color.blue(graphColor));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mPathGraph.lineTo(graphX, height);
